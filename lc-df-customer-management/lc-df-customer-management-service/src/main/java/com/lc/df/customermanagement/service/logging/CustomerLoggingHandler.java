...
public class CustomerLoggingHandler {
	...
	@AfterReturning(pointcut = "execution(* com.ladbrokes.customermanagement.controller..*(..))", returning = "result")
	...
	@AfterReturning(pointcut = "execution(* com.ladbrokes.customermanagement.service..*(..))", returning = "result")
